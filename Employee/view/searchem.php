...
<head>
    ...
    <script type="text/javascript" src="searchem.js"></script>
   </head>
<body>
<div class="menu-bar">
        <ul>
    ...
    <div align="center">
    <h1 id='myid'>Search Employe</h1>
    <form>
		<input type="text" name="name" id="name" value="" placeholder="Employe Name" onkeyup="ajax()" />
